...
function crcontact_func($atts, $content = null)
...
function renderShortcode($atts)
{
    ...
    $raw_image = new WP_Query(['post_type' => 'attachment', 'attachment_id' => $a['image']]);
...
if (!function_exists('grve_message_box_shortcode')) {
    function grve_message_box_shortcode($atts, $content)
    {
        ...
        /* / der Linkbuilder */
        $message_box_classes = ['grve-element', 'grve-message'];
...
vc_map([
    ...
    'params'      => [
        ...
        [
            ...
            'value'      => [__('If selected, close button will be removed ', 'grve-osmosis-vc-extension') => 'yes'],
        ],
                [
            'type'       => 'checkbox',
            'heading'    => __('Icon ausblenden', 'grve-osmosis-vc-extension'),
            'param_name' => 'remove_icon',
            'value'      => [__('Icon wird ausgeblendet', 'grve-osmosis-vc-extension') => 'remove_yes'],
        ],
            /* Dropdown-Menu um Verlinkung ein und auszublenden */
      [
            'type'        => 'dropdown',
