...
class Infolog
{
    static function New(InfologSchema $info_data){
    	$tables = $values = "(";
    	$i = 0;
    ...
    static function Update(int $info_id, InfologSchema $info_data){
    ...
    static function InfoTypes(){
		...
		return is_array($info_types) ? $info_types : array();
    }

    static function InfoStatus(){
        ...
        return is_array($info_statuses) ? $info_statuses : array();
    }

    static function getDefaultStatus($info_type){
