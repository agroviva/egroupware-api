...
class Categories
{
    ...
    public static function getByName($name){
        return Categories::Read(Api\Categories::name2id($name));
    } 
     ...
     * @param integer $parent      [0] if greater than 0 the category created will be a child
     */
     ...
     * @param boolean $drop_children [false] If true it will delete the children too
     */
